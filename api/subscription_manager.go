...
//
//	// Add subscriptions
//	sub1, ch1, _ := client.SubscriberApi.ToMomentums()
//	manager.Add(sub1)
//
//	sub2, ch2, _ := client.SubscriberApi.ToAllAccountBlocks()
//	manager.Add(sub2)
//
//	// Process events...
//
...
// Example:
//
//	sub, ch, err := client.SubscriberApi.ToMomentums()
//	if err != nil {
//	    return err
//	}
//	manager.Add(sub)
...
// Example:
//
//	sub1, _, _ := client.SubscriberApi.ToMomentums()
//	sub2, _, _ := client.SubscriberApi.ToAllAccountBlocks()
//	sub3, _, _ := client.SubscriberApi.ToAccountBlocksByAddress(addr)
//
